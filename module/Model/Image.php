...
class Image
{
	...
	public function findGeoCoords()
	{
		...
		if($georeverse && strlen($georeverse))
			$this->setCoordinates( Coordinates::findGeoCoords($georeverse) );

	}

	public function __construct()
	{
		$this->randompoint = array(rand(-180, 180),rand(-180, 180));
	 ...
	 * Set attributes
	 *
	 * @param Model\ImageAttributes $attributes
	 * @return self
	 */
	 ...
	 * Get attributes
	 *
	 * @return Model\ImageAttributes $attributes
	 */
